    ...
    <div class="row">
        <div class="col-md-4 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">                    
                    <form action="{{ route("artists.add") }}" id="add_form" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="col-md-8 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('artists.delete.multi') }}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-4">
                            <div class="input-group mb-3">
                        ...
                        <div class="col-8">
                            <a href="{{ route('artists.trash') }}" class="btn btn-primary btn-sm"><i class="las la-trash"></i> Trash</a>
                        </div>
                    </div>
                    <br>
                            ...
                            <tbody>
                                @foreach ($artists as $artist)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" data-id="{{ $artist->id }}" class="btn btn-sm btn-primary edit_modal"><i class="las la-edit"></i></button>
                                                <a href="{{ route('artists.delete.single', ['id' => $artist->id]) }}" onclick="return confirm('Are You Sure?')" class="btn btn-sm btn-danger"><i class="las la-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('artists.update') }}" method="POST" enctype="multipart/form-data">
              @csrf
            ...
            <div class="form-group mb-3">
                <input type="file" class="form-control" name="artist_img">
            </div>
