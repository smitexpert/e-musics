...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('musics.action') }}" method="POST">
                    @csrf
                <div class="row">
                    <div class="col-4">
                    ...
                    <div class="col-8">
                        <a href="{{ route('musics.all') }}" class="btn btn-info btn-sm"><i class="las la-chevron-left"></i> All Musics</a>
                        <a href="{{ route('musics.trash.empty') }}" class="btn btn-danger btn-sm"><i class="las la-trash"></i> Empty Trash</a>
                        <a href="{{ route('musics.trash.restore.all') }}" class="btn btn-primary btn-sm"><i class="las la-undo-alt"></i> Restore</a>
                    </div>
                </div>
                <br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('musics.trash.restore', ['id' => $music->id]) }}" class="btn btn-sm btn-primary"><i class="las la-undo-alt"></i></a>
                                            <a href="{{ route('musics.trash.delete', ['id' => $music->id]) }}" onclick="return confirm('Are You Sure?')" class="btn btn-sm btn-danger"><i class="las la-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
