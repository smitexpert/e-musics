	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" method="POST" action="{{ route('user.login.auth') }}">
					@csrf
					...
					<div class="flex-sb-m w-full p-b-48">
						...
						<div>
							<a href={{ route('user.forgot') }} class="txt3">
								Forgot Password?
							</a>
						</div>
					</div>
					...
					<div class="container-login100-form-btn" style="justify-content: space-between">
						...
						<a href="{{ route('user.register') }}" class="login100-form-btn" style="background-color: #57b846">
							Register
						</a>
					</div>
